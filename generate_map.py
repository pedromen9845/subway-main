...
def get_station_data(city):
    if city == 'beijing':
        ...
        url = 'http://map.amap.com/service/subway?_1469083453978&srhdata=4403_drw_shenzhen.json'
    elif city == 'tianjin':
        url = 'http://map.amap.com/service/subway?_1469083453978&srhdata=1200_drw_tianjin.json'
    ...
    return stations_info, neighbor_info, lines_info


def generate_map(city, source, target):

    stations_info, neighbor_info, lines_info = get_station_data(city)
    # Create graph
    city_graph = nx.Graph()
